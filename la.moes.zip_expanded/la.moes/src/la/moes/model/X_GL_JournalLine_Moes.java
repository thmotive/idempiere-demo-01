...
/** Generated Model for GL_JournalLine_Moes
 *  @author iDempiere (generated) 
 *  @version Release 8.2 - $Id$ */
public class X_GL_JournalLine_Moes extends PO implements I_GL_JournalLine_Moes, I_Persistent 
{
    ...
    public X_GL_JournalLine_Moes (Properties ctx, int GL_JournalLine_Moes_ID, String trxName)
    {
      super (ctx, GL_JournalLine_Moes_ID, trxName);
      /** if (GL_JournalLine_Moes_ID == 0)
        {
...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM GL_JournalLine WHERE GL_Journal_ID=@GL_Journal_ID@
    ...
    /** Load Constructor */
    public X_GL_JournalLine_Moes (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_GL_JournalLine_Moes[")
	...
	/** Set Journal Line.
		@param GL_JournalLine_Moes_ID Journal Line	  */
	public void setGL_JournalLine_Moes_ID (int GL_JournalLine_Moes_ID)
	{
		if (GL_JournalLine_Moes_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_GL_JournalLine_Moes_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_GL_JournalLine_Moes_ID, Integer.valueOf(GL_JournalLine_Moes_ID));
	}

	/** Get Journal Line.
		@return Journal Line	  */
	public int getGL_JournalLine_Moes_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_GL_JournalLine_Moes_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set GL_JournalLine_Moes_UU.
		@param GL_JournalLine_Moes_UU GL_JournalLine_Moes_UU	  */
	public void setGL_JournalLine_Moes_UU (String GL_JournalLine_Moes_UU)
	{
		set_Value (COLUMNNAME_GL_JournalLine_Moes_UU, GL_JournalLine_Moes_UU);
	}

	/** Get GL_JournalLine_Moes_UU.
		@return GL_JournalLine_Moes_UU	  */
	public String getGL_JournalLine_Moes_UU () 
	{
		return (String)get_Value(COLUMNNAME_GL_JournalLine_Moes_UU);
	}

	public I_GL_Journal_Moes getGL_Journal_Moes() throws RuntimeException
    {
		return (I_GL_Journal_Moes)MTable.get(getCtx(), I_GL_Journal_Moes.Table_Name)
			.getPO(getGL_Journal_Moes_ID(), get_TrxName());	}
